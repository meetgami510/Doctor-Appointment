...
const InfermedicaApi = (apiModel = 'infermedica-en', apiUrl = 'https://api.infermedica.com/v3/') => {
...
function SymptomChecker() {
    ...
    temp();
    const [obj, setObj] = useState({ text: "i feel smoach pain but no couoghing today", sex: "male", age: { value: 30 } });
